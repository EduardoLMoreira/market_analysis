...
\makeevenhead{meuestilo}{\includegraphics[height=1.1cm]{selo_55FCI.png}}{}{\thepage}
\makeoddhead {meuestilo}{\includegraphics[height=1.1cm]{selo_55FCI.png}}{}{\thepage}
\makeevenfoot{meuestilo}{}{\small{Campus Higienópolis:  Rua da Consolação, 930  -  Consolação  -  São Paulo - SP - CEP 01302-907\\
Tel. (11) 2114-8301  -  www.mackenzie.br - e-mail: fcidir@mackenzie.br}
}{}
\makeoddfoot {meuestilo}{}{\small{Campus Higienópolis:  Rua da Consolação, 930  -  Consolação  -  São Paulo - SP - CEP 01302-907\\
Tel. (11) 2114-8301  -  www.mackenzie.br -  e-mail: fci@mackenzie.br}
}{}

\makeheadrule{meuestilo}{\textwidth}{0.4pt}
\makefootrule{meuestilo}{\textwidth}{0.4pt}{0pt}
...
\titulo{Título - Estilo de artigo do trabalho de conclusão de curso da FCI}
\def \theforeigntitle{}
...
\textit{Este meta-artigo descreve o estilo a ser usado na confecção do artigo do trabalho de conclusão de curso da FCI. É solicitada a escrita de resumo e abstract. O resumo deve descrever, de forma sucinta, as principais partes do projeto: contexto, motivação, objetivo, justificativa, metodologia e resultados alcançados. O resumo deve conter de 150 a 250 palavras. O documento deve conter no máximo 20 páginas considerando as referências bibliográficas.}
 
 \vspace{\onelineskip}
 
 \noindent
 \textbf{Palavras-chave}: artigo científico; norma ABNT; trabalho de conclusão de curso.
\end{resumoumacoluna}
...
\textit{This meta-paper describes the style to be used for writing the FCI’s final paper. A “resumo” and abstract are required. The abstract must describe, in a direct form, the main project parts: context, motivation, objective, justification, methodology and results achieved. The abstract must have between 150 to 250 words. The document must contain a maximum of 20 pages, including bibliographical references.}

   \vspace{\onelineskip}
 
   \noindent
   \textbf{Keywords}: Scientific article; ABNT standards; undergraduate research paper.
 \end{otherlanguage*}  
\end{resumoumacoluna}
